...
export class Migrations1738491088681 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "device" (
            ...
            CONSTRAINT "UQ_b17080419bd45586a3e78dfcc96" UNIQUE ("name"), 
            CONSTRAINT "PK_2dc10972aa4e27c01378dad2c72" PRIMARY KEY ("id")
        )`);

        await queryRunner.query(`CREATE TABLE "device_datum" (
            "timestamp" TIMESTAMPTZ NOT NULL,
            "temperature" double precision, 
            "humidity" double precision, 
            "pressure" double precision, 
            "deviceId" integer, 
            CONSTRAINT "PK_9d8a520f9fa64dc072914b150e1" PRIMARY KEY ("timestamp", "deviceId")
        )`);

        await queryRunner.query(`SELECT create_hypertable('device_datum', 'timestamp')`);

        await queryRunner.query(`ALTER TABLE "device_datum" 
            ADD CONSTRAINT "FK_0a3d088535b3765ba1bf41ea48a" 
